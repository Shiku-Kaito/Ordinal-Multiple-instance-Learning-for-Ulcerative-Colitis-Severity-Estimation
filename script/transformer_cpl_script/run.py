...
import engine
import script.transformer_cpl_script.cpl_utils as cpl_utils
import lr_lambda
...
def run_fold(args, fold_idx):
    train_dataset, val_dataset, test_dataset, num_ranks = cpl_utils.get_train_val_test_datasets(args, fold_idx)
    ...
    model, criterion = cpl_utils.get_model_criterion(num_ranks, args)
...
def main():
    ...
    num_folds = cpl_utils.get_num_folds(args)
