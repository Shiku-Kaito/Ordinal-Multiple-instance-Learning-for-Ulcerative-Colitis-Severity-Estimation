...
class Transformer_POE(nn.Module):
    def __init__(
        self,
        num_classes=1000,
        embed_dim=768,
        ...
        # self.feature_extractor = make_layers(cfg['D'])
    ...
    def forward(self, x, len_list, max_t=50, use_sto=True):
        ...
        return {"bag":logit,"emb":emb, "log_var":log_var}
