...
def train_net(args, model, optimizer, train_loader, val_loader, test_loader, loss_function):
    ...
    log_dict = {"train_bag_acc":[], "train_bag_kap":[], "train_bag_f1":[], "train_ovs123_ins_acc":[], "train_ovs123_ins_f1":[], "train_o1vs23_ins_acc":[], "train_o1vs23_ins_f1":[], "train_o12vs3_ins_acc":[], "train_o12vs3_ins_f1":[], "train_emsemble_ins_acc":[], "train_emsemble_ins_kap":[], "train_emsemble_ins_f1":[], "train_loss":[], "train_loss1":[], "train_loss2":[], "train_loss3":[],
                "val_bag_acc":[], "val_bag_kap":[], "val_bag_f1":[], "val_ovs123_ins_acc":[], "val_ovs123_ins_f1":[], "val_o1vs23_ins_acc":[], "val_o1vs23_ins_f1":[], "val_o12vs3_ins_acc":[], "val_o12vs3_ins_f1":[], "val_emsemble_ins_acc":[], "val_emsemble_ins_kap":[], "val_emsemble_ins_f1":[],  "val_loss":[], "val_loss1":[], "val_loss2":[], "val_loss3":[],
                "test_bag_acc":[], "test_bag_kap":[], "test_bag_f1":[], "test_ovs123_ins_acc":[], "test_ovs123_ins_f1":[], "test_o1vs23_ins_acc":[], "test_o1vs23_ins_f1":[], "test_o12vs3_ins_acc":[], "test_o12vs3_ins_f1":[], "test_emsemble_ins_acc":[], "test_emsemble_ins_kap":[], "test_emsemble_ins_f1":[] }
    ...
    for epoch in range(args.num_epochs):
        ...
        for iteration, data in enumerate(train_loader): 
            ...
            y = model(bags)
            loss1, loss2, loss3 = loss_f_0vs123(y["y_0vs123"], ovs123_ins_label), loss_f_01vs23(y["y_01vs23"], o1vs23_ins_label), loss_f_012vs3(y["y_012vs3"], o12vs3_ins_label)
            loss = loss1 + loss2 + loss3 
            loss.backward()
            optimizer.step()
            optimizer.zero_grad()

            ins_labels.extend(ins_label.cpu().detach().numpy()), ovs123_ins_gt.extend(ovs123_ins_label.cpu().detach().numpy()), o1vs23_ins_gt.extend(o1vs23_ins_label.cpu().detach().numpy()), o12vs3_ins_gt.extend(o12vs3_ins_label.cpu().detach().numpy())
        ...
        ins_labels, ovs123_ins_gt, o1vs23_ins_gt, o12vs3_ins_gt =   np.array(ins_labels), np.array(ovs123_ins_gt), np.array(o1vs23_ins_gt), np.array(o12vs3_ins_gt)
        ...
        log_dict["train_ovs123_ins_acc"].append(ovs123_ins_metric["acc"]), log_dict["train_ovs123_ins_f1"].append(ovs123_ins_metric["macro-f1"])
        log_dict["train_o1vs23_ins_acc"].append(o1vs23_ins_metric["acc"]), log_dict["train_o1vs23_ins_f1"].append(o1vs23_ins_metric["macro-f1"])
        log_dict["train_o12vs3_ins_acc"].append(o12vs3_ins_metric["acc"]), log_dict["train_o12vs3_ins_f1"].append(o12vs3_ins_metric["macro-f1"])
        ...
        e_time = time()
        logging.info('[Epoch: %d/%d (%ds)] train loss: %.4f, loss1: %.4f, loss2: %.4f, loss3: %.4f, @Ins acc: %.4f, kapp: %.4f, macro-f1: %.4f' %
                     (epoch+1, args.num_epochs, e_time-s_time, log_dict["train_loss"][-1], log_dict["train_loss1"][-1], log_dict["train_loss2"][-1], log_dict["train_loss3"][-1], log_dict["train_emsemble_ins_acc"][-1], log_dict["train_emsemble_ins_kap"][-1], log_dict["train_emsemble_ins_f1"][-1]))
        ...
        log_dict["val_ovs123_ins_acc"].append(ovs123_ins_metric["acc"]), log_dict["val_ovs123_ins_f1"].append(ovs123_ins_metric["macro-f1"])
        log_dict["val_o1vs23_ins_acc"].append(o1vs23_ins_metric["acc"]), log_dict["val_o1vs23_ins_f1"].append(o1vs23_ins_metric["macro-f1"])
        log_dict["val_o12vs3_ins_acc"].append(o12vs3_ins_metric["acc"]), log_dict["val_o12vs3_ins_f1"].append(o12vs3_ins_metric["macro-f1"])
        ...
        e_time = time()
        e_time = time()
        logging.info('[Epoch: %d/%d (%ds)] val loss: %.4f, loss1: %.4f, loss2: %.4f, loss3: %.4f, @Ins acc: %.4f, kapp: %.4f, macro-f1: %.4f' %
                     (epoch+1, args.num_epochs, e_time-s_time, log_dict["val_loss"][-1], log_dict["val_loss1"][-1], log_dict["val_loss2"][-1], log_dict["val_loss3"][-1], log_dict["val_emsemble_ins_acc"][-1], log_dict["val_emsemble_ins_kap"][-1], log_dict["val_emsemble_ins_f1"][-1]))
        ...
        if args.is_test == True:
            ...
            log_dict["test_ovs123_ins_acc"].append(ovs123_ins_metric["acc"]), log_dict["test_ovs123_ins_f1"].append(ovs123_ins_metric["macro-f1"])
            log_dict["test_o1vs23_ins_acc"].append(o1vs23_ins_metric["acc"]), log_dict["test_o1vs23_ins_f1"].append(o1vs23_ins_metric["macro-f1"])
            log_dict["test_o12vs3_ins_acc"].append(o12vs3_ins_metric["acc"]), log_dict["test_o12vs3_ins_f1"].append(o12vs3_ins_metric["macro-f1"])
        ...
        make_bag_acc_graph(args, log_dict['train_ovs123_ins_acc'], log_dict['val_ovs123_ins_acc'], log_dict['test_ovs123_ins_acc'], "%s/acc_graph/fold=%d_seed=%d_ins-0vs123-acc-graph.png" % (args.output_path, args.fold, args.seed))
        make_bag_acc_graph(args, log_dict['train_ovs123_ins_f1'], log_dict['val_ovs123_ins_f1'], log_dict['test_ovs123_ins_f1'], "%s/acc_graph/fold=%d_seed=%d_ins-0vs123-macrof1-graph.png" % (args.output_path, args.fold, args.seed))

        make_bag_acc_graph(args, log_dict['train_o1vs23_ins_acc'], log_dict['val_o1vs23_ins_acc'], log_dict['test_o1vs23_ins_acc'], "%s/acc_graph/fold=%d_seed=%d_ins-01vs23-acc-graph.png" % (args.output_path, args.fold, args.seed))
        make_bag_acc_graph(args, log_dict['train_o1vs23_ins_f1'], log_dict['val_o1vs23_ins_f1'], log_dict['test_o1vs23_ins_f1'], "%s/acc_graph/fold=%d_seed=%d_ins-01vs23-macrof1-graph.png" % (args.output_path, args.fold, args.seed))

        make_bag_acc_graph(args, log_dict['train_o12vs3_ins_acc'], log_dict['val_o12vs3_ins_acc'], log_dict['test_o12vs3_ins_acc'], "%s/acc_graph/fold=%d_seed=%d_ins-012vs3-acc-graph.png" % (args.output_path, args.fold, args.seed))
        make_bag_acc_graph(args, log_dict['train_o12vs3_ins_f1'], log_dict['val_o12vs3_ins_f1'], log_dict['test_o12vs3_ins_f1'], "%s/acc_graph/fold=%d_seed=%d_ins-012vs3-macrof1-graph.png" % (args.output_path, args.fold, args.seed))
