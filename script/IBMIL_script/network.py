...
class TransMIL(nn.Module):
    def __init__(self, n_classes, input_size, confounder_path=None):
        ...
        if confounder_path:
            ...
            conf_list.append(torch.from_numpy(np.load(self.confounder_path)).float())
    ...
    def forward(self, x, len_list):
        ...
        results_dict = {'bag': logits, 'Y_prob': Y_prob, 'Y_hat': Y_hat, "Bag_feature":h, "A":A, 'h_not_norm':h_not_norm}        
        return results_dict
